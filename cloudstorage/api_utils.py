  ...
  def run(self, tasklet, **kwds):
    ...
    while True:
      ...
      try:
        ...
        raise
      except self.retriable_exceptions as err:
        # py3 implicitly deletes the except binding when the clause exits
        # (PEP 3110), so copy it to keep it visible to the retry logic below.
        e = err
